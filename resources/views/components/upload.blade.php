    ...
    <script>
        ...
        $picker.fileupload({
            ...
            add: (e, data) => { // Return true to continue adding, otherwise terminate
                ...
                else if (['mp4', 'webm'].indexOf(file.name.substring(file.name.lastIndexOf(".") + 1).toLowerCase()) !== -1) {
                    setThumb('data:image/png;base64,');
                }
                else if (['mp3', 'ogg', 'wav'].indexOf(file.name.substring(file.name.lastIndexOf(".") + 1).toLowerCase()) !== -1) {
                    setThumb('data:image/png;base64,');
                }
                else {
