...
@push('scripts')
    ...
    <script>
        ...
        let $picker = $('#picker');
        let queue = []; // 文件队列
        let excludes = ['psd', 'tif', 'tiff']; // 排除支持预览的格式
        let exvideos = ['webm', 'mp4']; // 排除支持预览的格式
        let exaudios = ['mp3', 'ogg', 'wav']; // 排除支持预览的格式
        /**
         * 设置状态
         * @param data
         * @param status
